...
train_data = gluon.data.DataLoader(train_dataset.transform(index_tokens),
                                   ...
                                   sampler=gluon.contrib.data.IntervalSampler(nbatch_train*args.batch_size,
                                                                              nbatch_train),
                                   last_batch='discard')
...
val_data = gluon.data.DataLoader(val_dataset.transform(index_tokens),
                                 batch_size=args.batch_size,
                                 sampler=gluon.contrib.data.IntervalSampler(nbatch_val*args.batch_size,
                                                                            nbatch_val),
                                 last_batch='discard')
...
test_data = gluon.data.DataLoader(test_dataset.transform(index_tokens),
                                  batch_size=args.batch_size,
                                  sampler=gluon.contrib.data.IntervalSampler(nbatch_test*args.batch_size,
                                                                             nbatch_test),
                                  last_batch='discard')
